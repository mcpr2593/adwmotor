...
// location
$data_provinsi =  $server->query("SELECT kode,nama FROM wilayah_2020 WHERE CHAR_LENGTH(kode)=2 ORDER BY nama")
        ...
        <div class="isi_setting_lokasi">
            ...
            <div class="form_provinsi_kota">
                <div class="isi_form_provinsi_kota">
                    <select class="" name="provinsi" id="provinsi" onchange="changeProvinsi()">
                        <option value="" selected disabled hidden>Pilih Provinsi</option>
                        <?php                       
                        while($rs_provinsi = mysqli_fetch_assoc($data_provinsi)){ 
                           echo '<option value="'.$rs_provinsi['id'].'">'.$rs_provinsi['name'].'</option>';
                        }                        
                      ?>
                    </select>
                    <img src="../../assets/image/loading.gif" width="35" id="load1" style="display:none;" />
                </div>
                <div class="isi_form_provinsi_kota">
