    ...
    <div class="back_tp_adm" id="back_tp_adm">
        <div class="isi_tp_adm">
            ...
            <div class="form_isi_tp_adm">
                ...
                <div class="box_varian_produk_adm">
                    <h5>Kredit / Cicilan</h5>
                    <p>Isi Nominal Uang Muka & Bulanan</p>
                    <div class="box_varian_produk_adm">
                        <?php
                        ...
                        <div class="isi_varian_produk_adm" id="box_add_kredit_varian_adm" onclick="add_kredit()">
                            <div class="add_warna_varian_adm">
                                <span>Tambah</span>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="jum_v_kredit" value="0">
                </div>
            </div>
            ...
            <div class="form_isi_tp_adm">
                ...
                <div class="box_varian_produk_adm">
                    ...
                    <div class="box_varian_produk_adm">
                        ...
                        <div class="isi_varian_produk_adm" id="box_add_kredit_varian_adm_ep" onclick="add_kredit_ep()">
                            <div class="add_warna_varian_adm">
                                <span>Tambah</span>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="jum_v_kredit_ep" value="0">
                </div>
