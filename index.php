    ...
    <div class="width">
        ...
        <div class="flash_sale">
            ...
            <div class="box_iklan_flash_sale grid_terlaris">
                <?php
                $produk_terlaris = $server->query("SELECT * FROM `iklan` WHERE `status`='' ORDER BY `id` DESC LIMIT 10");
        ...
        <div class="flash_sale">
            ...
            <div class="box_iklan_flash_sale grid_terlaris">
                <?php
                $produk_terlaris = $server->query("SELECT * FROM `iklan` WHERE `status`='' ORDER BY `iklan`.`terjual` DESC LIMIT 10");
                while ($produk_terlaris_data = mysqli_fetch_assoc($produk_terlaris)) {
                    $exp_gambar_pt = explode(',', $produk_terlaris_data['gambar']);
                ?>
                    <div class="list_produk">
