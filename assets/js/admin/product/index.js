...
function add_kredit() {
    var jum_v_kredit_v = document.getElementById('jum_v_kredit').value;
    var n_jum_v_kredit_v = parseInt(jum_v_kredit_v) + 1;
    var get_box_v_kredit_adm = 'box_v_kredit_adm' + n_jum_v_kredit_v;
    document.getElementById(get_box_v_kredit_adm).style.display = 'grid';
    jum_v_kredit.value = n_jum_v_kredit_v;
    if (n_jum_v_kreditn_v = 1) {
        box_add_kredit_varian_adm.style.display = 'none';
    }
}
...
function add_kredit_ep() {
    var jum_v_kredit_ep_v = document.getElementById('jum_v_kredit_ep').value;
    var n_jum_v_kredit_ep_v = parseInt(jum_v_kredit_ep_v) + 1;
    var get_box_v_kredit_adm = 'box_v_kredit_adm_ep' + n_jum_v_kredit_ep_v;
    document.getElementById(get_box_v_kredit_adm).style.display = 'grid';
    jum_v_kredit_ep.value = n_jum_v_kredit_ep_v;
    if (n_jum_v_kredit_ep_v = 1) {
